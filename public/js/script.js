...
function initNav() {
    if (easyMod) {
        $(".bb-bookblock").each(function() {
            $(this).append(
                '<a href="#" class="bb-flip bb-nav-prev">Previous<img src="http://www.kevin-li.com/magicbook/img/necessity/nav-prev.png"/></a>'
            );
        });
        $(".bb-bookblock").each(function() {
            $(this).append(
                '<a class="menu-button">"Show Menu"<div></div><div></div><div></div></a><a href="#" class="bb-flip bb-nav-next">Next<img src="http://www.kevin-li.com/magicbook/img/necessity/nav-next.png"/></a>'
            );
        });
        ...
        $(".bb-custom-side:even").each(function() {
            $(this).append(
                '<div class="page-foot-cover"></div><div class="page-head-cover"></div><a href="#" class="bb-flip bb-nav-prev">Previous<img src="http://www.kevin-li.com/magicbook/img/necessity/nav-prev.png"/></a>'
            );
        });
        $(".bb-custom-side:odd").each(function() {
            $(this).append(
                '<a class="menu-button">"Show Menu"<div></div><div></div><div></div></a><div class="page-head-cover"></div><div class="page-foot-cover"></div><a href="#" class="bb-flip bb-nav-next">Next<img src="http://www.kevin-li.com/magicbook/img/necessity/nav-next.png"/></a>'
            );
        });
        $(".bb-flip:first").hide();
        $(".bb-flip:last").hide();
...
Book.prototype._layout = function() {
    if (Modernizr.csstransforms3d) {
        this.book.innerHTML =
            '<div class="cover"><a href="###"><img src="http://' +
            window.location.hostname +
            '/gdsieunhan/public/img/page-corner.png" id="page-corner" /></a><div class="front" style="background: url(../public/img/cover-illustrator.jpg); background-size: cover"></div><div class="inner inner-left"></div></div><div class="inner inner-right"></div>';
    }
};
